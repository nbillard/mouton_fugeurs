...
/*
 * 8-03-24: V1.0 (Sebastien DI MERCURIO)
 *          Verifié sur carte Genuino
 *          Attention! Sur Genuino, les pins TX et RX de la sim7600 doivent etre sur PIN 0 et 1 respectivement (voir les jumpers)
 */
#include "SIM_7000.h"
...
//SIM_7000    sim7000(&mySerial); //Serial 1 is hardware serial on genuino 101
...
void setup() {
    ...
    Serial.println("Wait for blue led (Net) to switch on and power up messages from SIM7600...");
}
...
void loop() {
    ...
    //Serial1.listen();
    //if (Serial1.available()) Serial.println ("datareceived SIM");
    //if (Serial.available()) Serial.println ("datareceived USB");
