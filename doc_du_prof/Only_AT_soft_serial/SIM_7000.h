...
#if 1
#define SIM_DBG(...) {Serial.print("["); Serial.print(__FUNCTION__); Serial.print("(): "); Serial.print(__LINE__); Serial.print(" ] "); Serial.println(__VA_ARGS__);}
#else
#define SIM_DBG(...)
#endif

class SIM_7000 : public DFRobot_SIMcore{
public:
  /**
   * @enum eProtocol
